    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg p-6 text-white">
        ...
        <div className="flex items-center space-x-4">
          <button className="bg-white text-indigo-600 px-4 py-2 rounded-md font-medium hover:bg-gray-50 transition-colors">
            Continue Learning
          </button>
          <button className="border border-white text-white px-4 py-2 rounded-md font-medium hover:bg-white hover:text-indigo-600 transition-colors">
            Browse Courses
          </button>
        </div>
      </div>
