...
const WhatWeOffer = () => (
  <section className="w-full bg-white py-16 px-4">
    <div className="max-w-6xl mx-auto">
      ...
      >
        <motion.div
          className="text-center p-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 hover:shadow-lg transition-shadow"
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-[#0a174e] mb-2">Expert-Led Courses</h3>
          <p className="text-gray-600">Learn from industry professionals and subject matter experts with real-world experience.</p>
        </motion.div>
