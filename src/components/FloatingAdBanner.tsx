...
const FloatingAdBanner = () => {
  ...
  return (
    <div className="fixed top-1/2 right-0 z-50 transform -translate-y-1/2 flex flex-col items-center">
      <div className="relative bg-gradient-to-b from-yellow-400 via-yellow-500 to-yellow-600 text-white w-[378px] h-[756px] rounded-l-3xl shadow-2xl border-l-4 border-yellow-700 flex flex-col items-center py-0 px-0 animate-fade-in overflow-hidden">
        <button
